...
import { useEffect, useState } from "react";
import { useNavigate } from "react-router-dom";
import { Users, Send, BarChart3, PieChart, UserPlus } from "lucide-react";
import TopBar from "../../components/TopBar/TopBar";
import MessagePanel from "../../components/Reminders/MessagePanel";
import EnhancedReminderManager from "../../components/EnhancedReminderManager/EnhancedReminderManager";
    ...
    <div className="sd-page-wrap">
        ...
        <section className="sd-center">
          <div className="sd-actions">
            <button
              ...
              onClick={() => navigate("/superadmin/employees")}
            >
              <div className="sd-iconwrap sd-purple">
                <Users size={28} />
              </div>
              <div className="sd-action-title">Manage Employees</div>
              <div className="sd-action-sub">
                Browse all employees in a department
              </div>
            </button>

            {/* Add Employees (modal) */}
            <button className="sd-action" onClick={() => setShowAdder(true)}>
              <div className="sd-iconwrap sd-purple">
                <UserPlus size={28} />
              </div>
              <div className="sd-action-title">Add Employees</div>
              <div className="sd-action-sub">
                Single add or CSV (any department)
              </div>
            </button>
            ...
            <button
              ...
              onClick={() => navigate("/superadmin/analysis")}
            >
              <div className="sd-iconwrap sd-blue">
                <BarChart3 size={28} />
              </div>
              <div className="sd-action-title">Analysis</div>
              <div className="sd-action-sub">Department & employee trends</div>
            ...
            <button
              ...
              onClick={() => navigate("/superadmin/overview")}
            >
              <div className="sd-iconwrap sd-green">
                <PieChart size={28} />
              </div>
              <div className="sd-action-title">Company Overview</div>
              <div className="sd-action-sub">Org-wide summary & trends</div>
            ...
            >
              <div className="sd-iconwrap sd-orange">
                <Send size={28} />
              </div>
              <div className="sd-action-title">Send Message</div>
              <div className="sd-action-sub">
      ...
      {showAdder && (
        <DepartmentEmployeeAdder
          userRole="superadmin"
          department="" // superadmin için modal içinden seçilecek
